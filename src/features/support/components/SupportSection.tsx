        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="flex flex-col">
            <div className="mb-6 aspect-[4/3] bg-white rounded-lg flex items-center justify-center overflow-hidden">
              <img src={avassLogo} alt="Avass Media Logo" className="max-w-full max-h-full object-contain" />
            </div>
            <h3 className="text-xl font-extrabold text-primary text-center mb-4 font-title tracking-wide">Avass Media</h3>
          ...
          <div className="flex flex-col">
            <div className="mb-6 aspect-[4/3] bg-white rounded-lg flex items-center justify-center overflow-hidden">
              <img src={anchorAILogo} alt="Anchor AI Logo" className="max-w-full max-h-full object-contain" />
            </div>
            <h3 className="text-xl font-extrabold text-primary text-center mb-4 font-title tracking-wide">Anchor AI</h3>
            <p className="text-gray-700 text-center font-body">
          ...
          <div className="flex flex-col">
            <div className="mb-6 aspect-[4/3] bg-white rounded-lg flex items-center justify-center overflow-hidden">
              <img src={naturalVelocityLogo} alt="Natural Velocity Logo" className="max-w-full max-h-full object-contain" />
            </div>
